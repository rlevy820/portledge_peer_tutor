...
<body>
    <div class="sign-up-div"> 
        ...
        <form action="includes/user_cohort.inc.php" method="post">

            <p class="title">Select your cohort</p>
            <p class="second">You can always change this in your profile settings</p>

            <center><select name="user_cohort">
                <option value="A" name="a">A</option>
                <option value="B" name="b">B</option>
                <option value="O" name="o">O (Online)</option>
            </select><center>
            
            <button type="submit" name="select_cohort_submit">Next</button>  <br>
